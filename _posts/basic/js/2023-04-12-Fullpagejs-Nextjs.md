---
layout: posts
title: "Fullpage.js + Next.js + TypeScript를 사용한 웹 페이지 구현하기"
excerpt: "Fullpage.js, Next.js, 그리고 TypeScript를 함께 사용하여 멋진 웹 페이지를 구현"
search: true
categories:
- common
last_modified_at: 2023-04-12
---
안녕하세요, Fullpage.js, Next.js, 그리고 TypeScript를 함께 사용하여 멋진 웹 페이지를 구현하는 방법이 인터넷에 없어서 이렇게 블로그에 남겨봅니다. 

아래 예제는 Fullpage.js를 사용하여 섹션을 추가하고 제거하거나 색상을 변경하는 기능을 구현한 코드입니다.

[공식 next.js 샘플](https://github.com/alvarotrigo/react-fullpage/tree/master/examples/next)
을 참고 하였습니다.

구현되어 있는 제 github 코드는 아래에 있습니다.
[제깃헙주소](https://github.com/ThinkAllofYours/fullpage_nextjs_typescript.git)

준비물
---

먼저, 프로젝트에 필요한 패키지를 설치해야 합니다. 
package.json 파일을 참고해 주세요
